...
-- SELECT country.name, countrylanguage.language FROM country JOIN countrylanguage ON country.code = countrylanguage.countrycode WHERE countrylanguage.language = 'Italian' AND region = 'Southern Europe';
...
-- SELECT city.name FROM country JOIN city ON country.code = city.countrycode WHERE city.name LIKE 'Serra%' AND region = 'South America';
...
-- SELECT * FROM city WHERE city.id = '211';
