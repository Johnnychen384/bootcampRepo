...
//                      VERBAL QUESTIONS
// ========================================================
// 1. What is the difference between a paramete and an argument?
// // The argument is the input, the parameter is how the input is represented in the function.
// 2. Within a function, what is the difference between return and console.log?
// // Return is at the end of a function and stops the action that's taking place, it "returns" what has been requested at the end of performing the function's task.  Console.log just logs something to the console, it does not stop a function and doesn't perform any action other than what's in the console.log.  Console.log is mainly used for debugging while Return is used for performing tasks.
