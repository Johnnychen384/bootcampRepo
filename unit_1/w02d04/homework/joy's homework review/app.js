...
$('<h2>').text('Joy').appendTo($container);
$('<h3>').text('Slytherin').appendTo($container);
$('<h4>').text('Frank').addClass('cat').appendTo($container);
$('<h4>').text('Holly wand with a Phoenix Core, Springy').appendTo($container)
...
// YEAR 4 ===============
$('<h5>').text('Fall 2022').appendTo($container);
// table:
const $table = $('<table>');
