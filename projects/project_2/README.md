...
* Add additional relationships (models can be related in a one-to-many relationship, for example).
    - [Optional notes on having two models and relating them](https://git.generalassemb.ly/Software-Engineering-Immersive-Remote/SEIR-Eevee/tree/master/unit_2/w05d04/instructor_notes)
...
## Setting up for deployment (NOT REQUIRED FOR THIS PROJECT)
...
Your project is due on Monday November 28 at 9AM EST. You will present your project and show your code to classmates and instructors.

:heavy_check_mark: Add your project to [this google sheet](https://docs.google.com/spreadsheets/d/1zG63fEiU8RwGRyeieYUJt4YHOXaEJWz_j7qRMxqq4rs/edit?usp=sharing).
...
**TA Hours** (all normal times EST, unless otherwise stated from Issac) **NO TA HOURS on 11/24 * 11/25**
...
- [Potluck](https://secret-chamber-95709.herokuapp.com/)
...
- [infoSports infoStore](https://afternoon-plains-22414.herokuapp.com/)
- [Random Message Homepage](https://damp-sands-28949.herokuapp.com/)
