...
## Technical Goals
1. Able to run without syntax errors
2. Have index, show, create, new routes, using REST
3. Have basic MVC structure (more details below)
...
- Show
  - GET `/budgets/:id`<br>
- Edit
  - GET `/budgets/:id/edit`<br>
- Create
  - POST `/budgets`<br>
- Update
  - PUT `/budgets/:id`<br>
- Destroy
  - DELETE `/budgets/:id`<br>
